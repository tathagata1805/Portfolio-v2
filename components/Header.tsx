    ...
    <>
        ...
        <div className="flex justify-between px-4  py-2 text-white dark:text-white">
                  ...
                  >
                    <div className="px-1 py-1 ">
                      ...
                      <Menu.Item>
                        ...
                        >
                          Made with 💙 by Tathagata Chakraborty
                        </a>
                      </Menu.Item>
                    </div>
                  </Menu.Items>
          ...
          <Link href="/">
            <div className="flex gap-2 items-center">
              ...
              <h3 className="text-lg font-bold">Tathagata's Portfolio</h3>
            </div>
          </Link>
          <div className="pt-2">
      ...
      >
        <div className="flex flex-row justify-between px-8 py-4 text-white dark:text-white">
          <div>
            <p>
              Made with 💙 by <Link href="https://github.com/tathagata1805">Tathagata Chakraborty</Link>
            </p>
          </div>
          <Link href="/">
            <div className="flex gap-2 items-center">
